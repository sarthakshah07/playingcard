        ...
        <Grid item   xs={10} sx={{ marginLeft: "10%" }}>
          <Card sx={{ minWidth: 275 ,boxShadow:"1px 1px 20px 20px gray"}}>
            ...
            <Grid item xs={12} sx={{display:"flex"}}>
              <Grid item   xs={6}  sx={{display:"flex",flexDirection:"column-reverse", justifyContent:"center",alignItems:"center"}} >
              <img src={cardImg.data.url}  alt="no " style={{height:"280px"}}/>
             </Grid>
              
              
              <Grid item   xs={6}>
                <Typography sx={{   fontVariant: "small-caps",fontWeight: "bold", fontSize: "20px" }}>
                  Time Left:
                  <Timer TommorowDate={TommorowDate} />
                </Typography>
                <br />
                <Typography
                  sx={{ mt: 3, fontVariant: "small-caps",fontWeight: "bold", fontSize: "20px" }}
                >
